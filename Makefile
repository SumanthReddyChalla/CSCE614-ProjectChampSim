...
clean: 
	...
	$(RM) inc/ooo_cpu_modules.inc
	 ...
	 find prefetcher/next_line_custom -name \*.o -delete
	 find prefetcher/next_line_custom -name \*.d -delete
...
bin/champsim: $(patsubst %.cc,%.o,$(wildcard src/*.cc)) obj/repl_rreplacementDlru.a obj/pref_pprefetcherDno.a obj/pref_pprefetcherDno_instr.a obj/repl_rreplacementDlfu.a obj/pref_pprefetcherDnext_line_custom.a obj/bpred_bbranchDbimodal.a obj/btb_bbtbDbasic_btb.a
...
prefetcher/next_line_custom/%.o: CFLAGS += -Iprefetcher/next_line_custom
prefetcher/next_line_custom/%.o: CXXFLAGS += -Iprefetcher/next_line_custom
prefetcher/next_line_custom/%.o: CXXFLAGS +=  -Dprefetcher_initialize=pref_pprefetcherDnext_line_custom_initialize -Dprefetcher_cache_operate=pref_pprefetcherDnext_line_custom_cache_operate -Dprefetcher_cache_fill=pref_pprefetcherDnext_line_custom_cache_fill -Dprefetcher_cycle_operate=pref_pprefetcherDnext_line_custom_cycle_operate -Dprefetcher_final_stats=pref_pprefetcherDnext_line_custom_final_stats -Dl1d_prefetcher_initialize=pref_pprefetcherDnext_line_custom_initialize -Dl2c_prefetcher_initialize=pref_pprefetcherDnext_line_custom_initialize -Dllc_prefetcher_initialize=pref_pprefetcherDnext_line_custom_initialize -Dl1d_prefetcher_operate=pref_pprefetcherDnext_line_custom_cache_operate -Dl2c_prefetcher_operate=pref_pprefetcherDnext_line_custom_cache_operate -Dllc_prefetcher_operate=pref_pprefetcherDnext_line_custom_cache_operate -Dl1d_prefetcher_cache_fill=pref_pprefetcherDnext_line_custom_cache_fill -Dl2c_prefetcher_cache_fill=pref_pprefetcherDnext_line_custom_cache_fill -Dllc_prefetcher_cache_fill=pref_pprefetcherDnext_line_custom_cache_fill -Dl1d_prefetcher_final_stats=pref_pprefetcherDnext_line_custom_final_stats -Dl2c_prefetcher_final_stats=pref_pprefetcherDnext_line_custom_final_stats -Dllc_prefetcher_final_stats=pref_pprefetcherDnext_line_custom_final_stats
obj/pref_pprefetcherDnext_line_custom.a: $(patsubst %.cc,%.o,$(wildcard prefetcher/next_line_custom/*.cc)) $(patsubst %.c,%.o,$(wildcard prefetcher/next_line_custom/*.c))
	@mkdir -p $(dir $@)
	ar -rcs $@ $^
...
-include $(wildcard prefetcher/next_line_custom/*.d)
